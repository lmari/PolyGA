...
* _#individuals_ (integer from 1 to 20): number of individuals in the population / of the test polynomials
...
* _%mutation_ (integer from 0 to 100): probability * 100 of mutation / of parameter change, where 0 means that no genes are submitted to mutation and 100 means that all genes are submitted to mutation
